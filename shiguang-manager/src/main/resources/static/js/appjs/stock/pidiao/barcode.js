        ...
        $.ajax({
            ...
            success: function (datajson) {
                ...
                $(datajson).each(function (key) {  //循环读取后台传来的Json数据
                    ...
                    // localStorage.setItem('goodsCode',datajson[key].goodsCode);
                    // alert(localStorage.getItem('goodsCode'));

                    // alert(localStorage.length);
                    // for (var i=0;i<localStorage.length;i++){
                    //     alert('goodsCode'+i);
                    //     localStorage.setItem('goodsCode'+i,datajson[key].goodsCode);
                    // }

                    // if (localStorage.length==0){
                    //     alert('goodsCode'+0+"存入的key值");
                    //     localStorage.setItem('goodsCode'+0,datajson[key].goodsCode);
                    // }else {
                    //     var size=localStorage.length;
                    //     alert(size+"长度");
                    //     localStorage.setItem('goodsCode'+size,datajson[key].goodsCode);
                    // }
                    // else if (localStorage.length!=0){
                    //     alert(localStorage.length+"是第2条数据");
                    //     if(localStorage.length==1){
                    //         localStorage.setItem('goodsCode'+1,datajson[key].goodsCode);
                    //     }else {
                    //         var size=localStorage.length+1;
                    //         alert('goodsCode'+size+"存入的key值");
                    //         localStorage.setItem('goodsCode'+size,datajson[key].goodsCode);
                    //     }
                    //
                    // }
                    // for (var i=-1;i<localStorage.length;i++){
                    //     alert('goodsCode'+i+"取出的key值");
                    //     alert(localStorage.getItem('goodsCode'+i)+"曹立楠");
                    // }
                    // window.parent.$("#pidiaoNumber").val();
                    // var pidiaoNumber = $("#pidiaoNumber").val();
                    // alert(pidiaoNumber+"单据号");
                    // alert(window.parent.$("#pidiaoNumber").val()+"父亲单据号");
