			...
			.bootstrapTable(
					...
					//	showColumns : true,
						...
						columns : [
									...
									align : 'center',
									formatter : function(value, row, index) {
										var e = '<a class="btn btn-primary btn-xs '+s_edit_h+'" href="#" mce_href="#" title="检查" ' +
											'onclick="edit(\''+ value+ '\',\''+row.saleNumber+'\')" style="text-decoration: none;">检查</a> ';
