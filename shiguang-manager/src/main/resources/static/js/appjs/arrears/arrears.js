...
var prefix = "/information/arrears"
$(function() {
	load();
});
						...
						columns : [
								...
								},
							    {
									...
									formatter : function(value, row, index) {
                                        var e = '<a class="btn btn-primary btn-xs" href="#" title="缴费"  mce_href="#" ' +
												 'onclick="jiaofei(\''+ value+ '\',\''+row.saleNumber+'\')" style="text-decoration: none;">缴费</a>';
...
function jiaofei(cardNumber,saleNumber) {
    var toIndex = layer.open({
		type : 2,
		title : '缴费',
		maxmin : true,
