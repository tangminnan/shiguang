...
var prefix = "/information/overline"
$(function() {
	//load();
});
								...
								},
                            {
                                ...
                                title : '验光室'
									...
									formatter : function(value, row, index) {
                                        ...
                                        var l = '<a class="btn btn-primary btn-xs" href="#" title="恢复"  mce_href="#" onclick="reoverLine(\''
                                            + row.id
                                            + '\')" style="text-decoration: none;">恢复</a>';
										return l;
									}
								}
								]
...
function reoverLine(id){
    $.ajax({
        url : prefix+"/reoverLine",
        type : "post",
        data : {
            'id' : id
        },
