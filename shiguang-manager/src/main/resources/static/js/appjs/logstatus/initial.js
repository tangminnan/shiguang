...
var prefix = "/information/initial"
$(function() {
	load();
});
			...
			.bootstrapTable(
					{
						...
						url : prefix + "/initiallist", // 服务器数据的加载地址
					//	showRefresh : true,
					//	showToggle : true,
					//	showColumns : true,
						iconSize : 'outline',
...
function batchInitial() {
	var rows = $('#exampleTable').bootstrapTable('getSelections'); // 返回所有选择的行，当没有选择的记录时，返回一个空数组
	if (rows.length == 0) {
		layer.msg("请选择要加工初检的数据");
		return;
	}
	var initial="";
    layer.open({
       ...
       shadeClose : false, // 点击遮罩关闭层
       area : [ '500px', '220px' ],
       content : '/information/initial/initialpl/', // iframe的url
       btn: ['确定', '取消'],
