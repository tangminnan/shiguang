...
public class SerialDataEyesUtils {
...
//    private EyePressureDao eyePressureDao = (EyePressureDao) SpringUtil.getBean("eyePressureDao");
    ...
    public static SerialDataEyesUtils serialDataUtils = null;

    private SerialDataEyesUtils() {
    }

    public static SerialDataEyesUtils getSerialPortUtils() {
        if (serialDataUtils == null) {
            serialDataUtils = new SerialDataEyesUtils();
        }
...
//                    eyePressureDao.lsSave(eyepressureDOBean);
                ...
                case "isOptometry":
                    ...
                    BleDataBean bleDataBean = SerialDataEyesUtils.toOptometry(isOptometry);
